...
namespace ReBottle.Models.Migrations
{
    ...
    [Migration("20250525180133_ImageStorageLinkRecycle")]
    partial class ImageStorageLinkRecycle
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReBottle.Models.ImageStorage", b =>
                {
                    b.HasOne("ReBottle.Models.RecyclingRecord", "RecyclingRecord")
                        .WithOne("ImagesStorage")
                        .HasForeignKey("ReBottle.Models.ImageStorage", "RecyclingRecordId")
